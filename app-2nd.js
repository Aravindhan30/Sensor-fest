...
const BASIC_POOL_FALLBACK = [
  ...
  { id: 'S080', name: 'DS3231 RTC (Real-Time Clock) Module'        },
  { id: 'S092', name: 'TM1637 4-Digit 7-Segment Display'           },
  { id: 'S111', name: 'WCS1700 AC/DC Current Sensor (35A)'         },
  { id: 'S017', name: 'MQ-7 Carbon Monoxide (CO) Sensor'           },
  { id: 'S019', name: 'MQ-9 CO / Combustible Gas Sensor'           },
  { id: 'S021', name: 'MQ-136 Hydrogen Sulphide Sensor'            },
  { id: 'S060', name: 'Optical Encoder Disc (for motor)'           },
  { id: 'S062', name: 'Current Sensor Module ACS712 (5A)'          },
  { id: 'S063', name: 'Current Sensor ACS712 (20A)'                },
  { id: 'S084', name: 'INA219 Current + Voltage Sensor (I²C)'      },
  { id: 'S091', name: '16×2 LCD with I²C Adapter (PCF8574)'        },
  { id: 'S093', name: 'MAX7219 8×8 LED Matrix Module'              },
  { id: 'S097', name: 'L298N Motor Driver Module'                  },
  { id: 'S110', name: '74HC595 Shift Register Module'              },
  { id: 'S040', name: 'BMP085 Barometric Pressure Sensor'          },
  { id: 'S048', name: 'MAX4466 Electret Mic Amplifier'             },
  { id: 'S077', name: 'ESP8266 Wi-Fi Module (ESP-01)'              },
  { id: 'S090', name: 'OLED 0.96" I²C Display Module'              },
  { id: 'S096', name: '28BYJ-48 Stepper Motor + ULN2003 Driver'    },
  { id: 'S085', name: 'HX711 Load Cell Amplifier + 1 kg Load Cell' },
];
